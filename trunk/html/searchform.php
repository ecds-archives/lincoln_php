...
print "<div class='content' id='search'>";
...
<tr><th>Keyword</th><td class="input"><input type="text" size="40" name="keyword"></td></tr>
<tr><th>Title</th><td class="input"><input type="text" size="40" name="title"></td></tr>
<tr><th>Author</th><td class="input"><input type="text" size="40" name="author"></td></tr>
<tr><th>Sermon Date</th><td class="input"><input type="text" size="40" name="date"></td></tr>
<tr><th>Place of Publication</th><td class="input"><input type="text" size="40" name="place"></td></tr>
