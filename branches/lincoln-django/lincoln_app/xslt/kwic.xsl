...
<!--  <xsl:param name="keyword"/>-->
  ...
  <xsl:template match="/">
    ...
    <div class="kwic">
      <p>
        <a>
          <xsl:attribute name="href">sermon.php?id=<xsl:value-of select="//@id"/>&amp;<xsl:value-of select="$url_suffix"/></xsl:attribute>
          <xsl:value-of select="//head//title"/>, <xsl:value-of select="//head//author"/>. 
        </a>
      </p>
    </div>
