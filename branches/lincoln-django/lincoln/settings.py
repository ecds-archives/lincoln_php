...
# hostname, port, & path to exist xmlrpc - e.g., "localhost:8080/exist"
...
EXISTDB_TEST_COLLECTION = "/lincoln-AH/"
...
SECRET_KEY = 'nqnf5t8_h3@6i^k*1(u6ul87l1bgm_(kg8vw%)a2h@r*8af*f8'
